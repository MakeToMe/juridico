 ...
 * Usa o formato correto para preencher os campos do número do processo
 */
...
async function consultarProcesso() {
  ...
  try {
    ...
    await page.screenshot({ path: './antes-consulta-correto.png' });
    ...
    await page.screenshot({ path: './depois-consulta-correto.png' });

/**
 * Script final para consultar um processo no TJAL
 * Usa os seletores corretos identificados pelo diagnóstico
 */
...
async function consultarProcesso() {
  ...
  try {
    ...
    // Baseado no diagnóstico, o ID correto é #radioNumeroUnificado
    ...
    await page.screenshot({ path: './antes-consulta-final.png' });
    ...
    await page.screenshot({ path: './depois-consulta-final.png' });

/**
 * Script corrigido para consultar processo no TJAL
 * Lida corretamente com o bloco fixo "8.02" que já vem preenchido
 */
...
async function consultarProcessoTJAL() {
  ...
  try {
    ...
    // Aguardar redirecionamento após login com timeout maior
    ...
    await page.goto(URL_CONSULTA, { timeout: 60000 });
    
    // Aguardar carregamento da página de consulta
    await page.waitForSelector('#radioNumeroUnificado', { timeout: 60000 });
    ...
    await page.waitForSelector('#containerDadosPrincipaisProcesso', { timeout: 60000 }).catch(() => {

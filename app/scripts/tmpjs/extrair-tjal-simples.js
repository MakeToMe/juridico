...
// Configurações
const config = {
  // Credenciais para acesso ao TJAL (as mesmas do script original)
...
async function consultarProcesso() {
  console.log(`Iniciando extração de dados do processo ${config.numeroProcesso} no TJAL`);
  ...
  try {
    ...
    // 5. Selecionar opção de número unificado
    ...
    // 9. Aguardar um pouco mais para garantir que a página carregou completamente
    ...
    // 13. Salvar em arquivo JSON com o número do processo no nome
    ...
    // 14. Aguardar para visualização manual
